   ...
   public static function categoryName($id)
    {
        ...
        $categories_id = DB::table('sub_categories')->where('id', $subcategories_id)->get()->pluck('category_id');
        $categories_name=DB::table('categories')->where('id', $subcategories_id)->get()->pluck('name');
