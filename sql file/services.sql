...
(1, 'Switch Installation and Repair', 'At ultrices mi tempus imperdiet nulla malesuada pellentesque elit. Lorem ipsum dolor sit amet consectetur adipiscing.', 1, 'switch.png', 1, 1.00, NULL, NULL, NULL),
(2, 'Socket Installation and Repair', 'llamcorper velit sed. Volutpat est velit egestas dui id ornare arcu odio. Quisque sagittis purus', 1, 'switch.png', 1, 1.00, NULL, NULL, NULL),
(3, 'Holder Installation and Repair', 'sit amet volutpat consequat mauris nunc. Tristique senectus et netus et malesuada fames ac turpis. Ante metus dictum at tempor commodo ullamcorper.', 1, 'switch.png', 1, 1.00, NULL, NULL, NULL),
(4, 'Switch and Socket Replacement', 'Eget arcu dictum varius duis at. Eget nunc lobortis mattis aliquam faucibus purus in massa tempor.', 1, 'switch.png', 1, 1.00, NULL, NULL, NULL),
(5, 'Ceiling fan servicing', 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Morbi tortor erat, malesuada vel urna id, finibus accumsan mi. Integer tempus elementum augue, non congue augue tincidunt eu.', 1, 'fan', 2, 1.00, NULL, NULL, NULL),
(6, 'Wall fan servicing', 'Sed nec molestie erat. Proin in varius mauris. Sed eu neque hendrerit, fringilla neque quis, consectetur orci. Pellentesque ultrices cursus turpis, vitae varius magna porta non.', 1, 'fan.png', 2, 1.00, NULL, NULL, NULL),
(7, 'Table stand servicing', 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Morbi tortor erat, malesuada vel urna id, finibus accumsan mi. Integer tempus elementum augue, non congue augue tincidunt eu. ', 1, 'fan.png', 2, 1.00, NULL, NULL, NULL),
(8, 'Exhaust fan servicing', 'Sed nec molestie erat. Proin in varius mauris. Sed eu neque hendrerit, fringilla neque quis, consectetur orci. Pellentesque ultrices cursus turpis, vitae varius magna porta non.', 1, 'fan.png', 2, 1.00, NULL, NULL, NULL),
(9, 'Fan installation', 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Morbi tortor erat, malesuada vel urna id, finibus accumsan mi. Integer tempus elementum augue, non congue augue tincidunt eu.', 1, 'fan.png', 2, 1.00, NULL, NULL, NULL),
